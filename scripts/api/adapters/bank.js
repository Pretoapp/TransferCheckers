...
function normalizeMockEntry(entry, ref) {
...
export async function fetchBankTransfer(reference, provider = (typeof import.meta !== 'undefined' && import.meta.env?.VITE_BANK_PROVIDER) || 'mock') {
    if (provider === 'mock') {
